 ...
 */
function pop_custom_colors_css() {
	 ...
	 */
	$saturation = absint( apply_filters( 'pop_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.pop-front-page) .entry-title,
...
.colors-custom .pop-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.pop-front-page .panel-content .recent-posts article,
...
.colors-custom.pop-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 'pop_custom_colors_css', $css, $hue, $saturation );
}
